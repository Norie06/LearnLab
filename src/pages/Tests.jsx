    ...
    <div id="quizzes" className="page">
      ...
      <main>
        ...
        <div id='quizzes_choose_quiz' className='choose_quiz'>
          <ChooseQuizItem title="Learning Styles Test" image="/images/note-brain-icon.svg" path="/tests/learning-style-test" element={<NoteTaking />} desc={"Many people have a mix of learning styles! Use this test to identify your strengths and combine techniques for a more effective study experience."} />
          ...
          <ChooseQuizItem title="Note-taking Techniques Test" image="/images/note-taking-icon.svg" path="/tests/note-taking-test" element={<LearningStyles />} desc={"Everyone has their own way of taking notes! Your results will highlight the method that suits you best—but don’t be afraid to mix and match for even better learning."} />
        </div>
